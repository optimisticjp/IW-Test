  ...
  return (
    <section className="bg-white py-[clamp(60px,8vw,96px)] px-5">
      <div className="max-w-[1080px] mx-auto">
        ...
        >
          {HIGHLIGHTS.map((cs) => (
            <motion.div key={cs.id} variants={card}>
              <GlassCard hover className="overflow-hidden h-full">
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center gap-2 mb-4">
                    <span className="text-[10px] font-extrabold tracking-widest uppercase px-2.5 py-1 rounded-full text-brand-600 bg-brand-50">
                      {cs.category}
                    </span>
                  ...
                  <div className="text-[clamp(22px,3.5vw,30px)] font-black tracking-tightest leading-none mb-1 gradient-text">
                    {cs.result}
                  </div>
