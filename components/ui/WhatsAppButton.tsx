 ...
 *
 * SETUP: Add your WhatsApp number to lib/constants.ts
 * Find the SITE object and add:
 *   whatsapp: '+447700000000',  // your number with country code
 *
 * If SITE.whatsapp is empty or missing, this component renders nothing.
 */
...
export default function WhatsAppButton() {
  // Cast to any to allow accessing optional whatsapp field
  ...
  const message = encodeURIComponent(
    "Hi, I found Infinite Weblinks and I'd like to discuss my project."
  )
